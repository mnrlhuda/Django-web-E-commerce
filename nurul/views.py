...
from .models import Produk, Profil, Slide, Kategori, Kontak, Statis, ChatID
from huda.models import Transaksi, DetailTransaksi
...
from huda.forms import CartAddProductForm
from huda.keranjang import Cart
import datetime
...
class KontakView(View):
    ...
    def post(self, request):
        context = {
            'judul': 'Halaman Kontak', 'data': request.POST, 'has_error': False
        }
